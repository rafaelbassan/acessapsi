...
const AvaliacoesSection = () => {
  ...
  return (
    <section id="avaliacoes" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-wisdom-50 via-white to-wisdom-25">
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`text-center mb-8 sm:mb-12 lg:mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="flex justify-center mb-4 sm:mb-6">
            <div className="bg-wisdom-100 p-3 sm:p-4 rounded-full">
              <FileText className="w-8 h-8 sm:w-12 sm:h-12 text-wisdom-600" />
            </div>
          </div>
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed text-no-overflow px-2 sm:px-0">
        ...
        {/* Content Grid */}
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center mb-8 sm:mb-12">

          {/* Left Column - Benefits */}
          <div className={`space-y-4 sm:space-y-6 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-4 sm:mb-6">O que oferecemos:</h3>

            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-wisdom-600 mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-slate-800 text-sm sm:text-base">Avaliação Completa</h4>
                  <p className="text-slate-600 text-sm sm:text-base text-no-overflow">Bateria completa de testes psicológicos validados cientificamente.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-wisdom-600 mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-slate-800 text-sm sm:text-base">Relatório Detalhado</h4>
                  <p className="text-slate-600 text-sm sm:text-base text-no-overflow">Análise completa com recomendações personalizadas e acionáveis.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-wisdom-600 mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-slate-800 text-sm sm:text-base">Orientação Profissional</h4>
                  <p className="text-slate-600 text-sm sm:text-base text-no-overflow">Discussão dos resultados com psicólogo especializado.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-wisdom-600 mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-slate-800 text-sm sm:text-base">Aplicações Práticas</h4>
                  <p className="text-slate-600 text-sm sm:text-base text-no-overflow">Insights aplicáveis à carreira, relacionamentos e desenvolvimento pessoal.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* CTA Section */}
        <div className={`text-center bg-gradient-to-r from-wisdom-100 to-wisdom-200 rounded-2xl p-6 sm:p-8 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <button
            ...
            className="bg-wisdom-600 hover:bg-wisdom-700 text-white font-semibold px-6 sm:px-8 py-2.5 sm:py-4 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2 sm:space-x-3 mx-auto group shadow-lg hover:shadow-xl btn-mobile"
          >
